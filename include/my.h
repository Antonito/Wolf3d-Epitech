...
** Last update Wed Dec 23 23:52:00 2015 Antoine Baché
*/
...
void			display_texture_wall(t_main_menu *, int, int,
					     t_vector *);
void			display_texture_player(t_main_menu *, int, int,
					     t_vector *);
int			bmp_error(void);
int			prepare_texture(t_main_menu *);
void			loop_texture(t_main_menu *, int);
t_bunny_response	key(t_bunny_event_state, t_bunny_keysym,
			    t_main_menu *);
...
void			move_player_next(t_main_menu *, double);
...
void			set_client_position_lower(t_main_menu *, int, int);
