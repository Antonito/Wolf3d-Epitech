...
** Last update Sun Dec 20 17:52:33 2015 Antoine Baché
*/

#include "my.h"

void	server_pos(UNUSED t_main_menu *data)
{
  return ;
  /*
...
void	client_pos(UNUSED t_main_menu *data)
{
  return ;
}

void	calc_pos_player(UNUSED t_main_menu *data)
{
  return ;
