...
** Last update Tue Dec 22 02:27:55 2015 Antoine Baché
*/
...
int	main_menu_texture(t_main_menu *menu)
{
  if (load_bmp(menu->texture[0], "img/main_menu/ExitPNG.bmp") == 1 ||
      load_bmp(menu->texture[1], "img/option_menu/OptionTitle.bmp") == 1 ||
      load_bmp(menu->texture[2], "img/main_menu/Play.bmp") == 1 ||
